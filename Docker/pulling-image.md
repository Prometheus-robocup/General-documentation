...
### Quick Command
```
sudo docker image pull name_of_image:tag
```
### Detailed version
...
For more information about images, layers, and the content-addressable store, refer to the Docker documentation on [images, containers, and storage drivers](https://docs.docker.com/storage/storagedriver/).
